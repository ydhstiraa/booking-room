...
// Query SQL
$selectDataTable = "SELECT pemesanan.*, ruangan.nama, validasi.kode_tracking FROM pemesanan left join validasi on pemesanan.id = validasi.pemesanan_id LEFT JOIN ruangan ON pemesanan.ruangan_id = ruangan.id where pemesanan.status = 'Finished' || pemesanan.status = 'Cancel' ORDER BY timestamp DESC";
