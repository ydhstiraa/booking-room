...
$top5Booking = mysqli_query($conn, "select pemesanan.id, pemesanan.tanggal_pemesanan, pemesanan.nama_pemesan, pemesanan.jam_mulai, pemesanan.jam_selesai, ruangan.nama, pemesanan.keterangan from pemesanan left join ruangan on pemesanan.ruangan_id = ruangan.id ORDER BY pemesanan.tanggal_pemesanan asc LIMIT 5");
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">5 Upcoming Event</div>
                </div>
                <div class="card-body">
